          ...
          <div className="">
            <div className="">
              <div className="">
                ...
                <p className="text-white text-sm py-2 text-shadow-sm">
                  Selamat Datang di Summit Pages! <br /> Rumah bagi Anda yang gemar Membaca dan Menjelajahi <br /> Dunia melalui Buku. Kami menyediakan Akses Tanpa Batas <br /> ke berbagai Genre, mulai dari Biografi hingga <br />{' '}
                  Pengembangan Diri yang dirancang untuk Kebutuhan Anda. <br /> Mari Eksplorasi dimanapun Anda berada. <br /> <br /> Summit Pages, The More You Read The More You Know!
                </p>
              </div>
            ...
            <div className="py-3">
              <div className="">
                ...
                <p className="text-white text-sm py-2 text-shadow-sm">&quot;Summit Pages adalah platform perpustakaan yang <br/> membantu Anda menemukan buku yang sesuai dengan <br/> minat dan kebutuhan Anda. Cari, baca, dan nikmati!&quot;</p>
              </div>
              <div className="w-3/4 h-0.5 bg-white mt-5"></div>
            </div>
          </div>
